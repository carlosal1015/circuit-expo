...
\begin{frame}[fragile]
	\frametitle{\secname~\parencite[Capítulo 3]{Lynch2018}}
	\begin{minipage}{0.45\textwidth}
		\begin{listing}[H]
			\inputminted[
				fontsize=\tiny,
			...
			\caption{\texttt{chua\_double\_scroll.py} usa la función~\href{https://docs.scipy.org/doc/scipy/reference/generated/scipy.integrate.odeint.html}{\mintinline{python}{scipy.integrate.odeint}}.}
		\end{listing}
	\end{minipage}
	\begin{minipage}{0.45\textwidth}
...
% \begin{frame}[fragile]
% 	\frametitle{\secname}
% 	\href{https://docs.scipy.org/doc/scipy/reference/generated/scipy.integrate.solve_ivp.html}{\mintinline{python}{scipy.integrate.solve_ivp}}
% 	\begin{minipage}{0.45\textwidth}
% 		\inputminted[
% 			fontsize=\tiny,
% 			highlightlines={13-16,28-30,33-38},
% 			firstline=1,
% 			lastline=41,
% 			escapeinside=||
% 		]{python}{chua_double.py}
% 	\end{minipage}
% 	\begin{minipage}{0.45\textwidth}
% 		\inputminted[fontsize=\tiny, highlightlines={13-16,28-30,33-38}, firstline=1, lastline=41]{python}{poincare_chua.py}
% 	\end{minipage}
